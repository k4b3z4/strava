...
if(document.all)
 ...
 function createToolTip(TooltipDivID,Color,Title,Message)
  {
   ...
   HTML    += "<div style='background-color: #808080; border-top: 2px solid #606060; font-family: tahoma; font-size: 11px; padding: 2px;'>";
   HTML    += "<table style='border: 0px; padding: 0px; margin: 0px;'><tr valign='top'><td style='padding-top: 4px;'><table style='background-color: "+Color+"; border: 1px solid #000000; width: 9px; height: 9px;  padding: 0px; margin: 0px; margin-right: 2px;'><tr><td></td></tr></table></td><td style='color: #000;'>"+Message+"</td></tr></table>";
   HTML    += "</div></div>";
 ...
 function addArea(imageMapID,shapeType,coordsList,actionOver,actionOut,URL)
  {
   ...
   for(i=0;i<=Zones.length-2;i++)
    {
     ...
     var Option2 = Options[4].split(";");
     addArea(ImageMapID,
             Options[0],
             Options[1],
             'showDiv("testDiv","'+Options[2]+'","'+Options[3]+'","'+Option2[0].replace('"','')+'");','hideDiv("testDiv");',
             Option2[1]);
    }
  }
