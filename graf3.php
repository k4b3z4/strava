...
// ************************* GRAFICO !!!!! **************************************
	...
	$myPicture->drawFilledRectangle(0,0,900,320,$Settings); 

	/* Overlay with a gradient */ 
	$Settings = array("StartR"=>219, "StartG"=>231, "StartB"=>139, "EndR"=>1, "EndG"=>138, "EndB"=>68, "Alpha"=>50); 
	$myPicture->drawGradientArea(0,0,900,320,DIRECTION_VERTICAL,$Settings); 
	...
	$myPicture->drawRectangle(0,0,899,319,array("R"=>0,"G"=>0,"B"=>0)); 
	...
	$myPicture->setGraphArea(90,40,850,290); 
	$myPicture->drawFilledRectangle(90,40,850,290,array("R"=>255,"G"=>255,"B"=>255,"Surrounding"=>-200,"Alpha"=>10)); 
	...
	if( $mismo_anio){
			$skip = 0;
			$myPicture->drawText(400,20, $desde_y. "-" . $hasta_y  ,array("R"=>0,"G"=>0,"B"=>0));
	}else{
		if( $mismo_mes ){
			$skip = 0; 
			$myPicture->drawText(400,20, $mes."-".$anio  ,array("R"=>0,"G"=>0,"B"=>0));  	
		}else{
			$myPicture->drawText(340,20, $desde_d."-".$desde_m."-".$desde_y . " - " .
	  							         $hasta_d."-".$hasta_m."-".$hasta_y ,array("R"=>80,"G"=>80,"B"=>80));  			
		}
	}
